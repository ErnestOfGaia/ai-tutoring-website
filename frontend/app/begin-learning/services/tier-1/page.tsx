...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ernestofgaia.xyz/begin-learning/services/tier-1",
  },
};
...
export default function Tier1() {
  return (
    <PageLayout
      ...
      prevLabel="← Services"
      next="/begin-learning/services/tier-2"
      nextLabel="Tier 2 →"
      breadcrumbs={[
        { label: "Services", href: "/begin-learning/services" },
        { label: "Tier 1: Foundations", href: "/begin-learning/services/tier-1" },
      ]}
      jsonLd={tier1JsonLd}
    >

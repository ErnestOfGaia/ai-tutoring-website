...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ernestofgaia.xyz/begin-learning/how-it-works",
  },
};
  ...
  step: [
    {
      ...
      url: "https://ernestofgaia.xyz/begin-learning/how-it-works/step-1",
    },
    {
      "@type": "HowToStep",
      position: 2,
      ...
      url: "https://ernestofgaia.xyz/begin-learning/how-it-works/step-2",
    },
    {
      "@type": "HowToStep",
      position: 3,
      ...
      url: "https://ernestofgaia.xyz/begin-learning/how-it-works/step-3",
    },
    {
      "@type": "HowToStep",
      position: 4,
...
export default function HowItWorks() {
  return (
    <PageLayout
      ...
      breadcrumbs={[{ label: "How It Works", href: "/begin-learning/how-it-works" }]}
      jsonLd={howToJsonLd}
    >
      <h1>How It Works</h1>
      ...
      <div className="eogbook-drilldown" aria-label="Explore each step in detail">
        ...
        <a
          href="/begin-learning/how-it-works/step-2"
          className="eogbook-drill-link"
        >
          Step 2: How to choose the right tier
        </a>
        <a
          href="/begin-learning/how-it-works/step-3"
          className="eogbook-drill-link"
        >

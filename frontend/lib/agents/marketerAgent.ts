...
- Tagline: "AI for your Home, Hobby, or Business"
- Approach: A Human-Centered Approach to AI — coaching that fits the way you work, think, and live.
- Contact: eog@ErnestOfGaia.xyz | 503-664-0546 (texting preferred)
- LinkedIn: linkedin.com/in/ernestofgaia | YouTube: youtube.com/@ErnestOfGaia

EOGbook Context (Most Relevant for Marketing):
- EOGbook is our online guide. You can guide users to specific pages:
  - /begin-learning/services : Details our coaching tiers.
  ...
  - /begin-learning/what-i-do : Explains practical AI skills and lifelong learning.
